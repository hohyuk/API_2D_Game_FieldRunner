...
namespace UI_TYPE
{
	enum CLASS_ID { LOGO_UI, HELP_UI, GAME_UI, SELECT_UI, EXIT_UI, OPTION_UI, END_UI };
	enum BUTTON { PLAY_BTN, HELP_BTN, SCORE_BTN, EDIT_BTN, NEXT_BTN, BACK_BTN, STAGE1_BTN, STAGE2_BTN, STAGE3_BTN, EXIT_BTN, END_BTN };
}