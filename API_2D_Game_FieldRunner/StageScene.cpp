...
void StageScene::Ready()
{
	...
	Create_UI(TEXT("Goo"), INFO(1150, 900, 133, 117), UI_TYPE::CLASS_ID::TOWER_UI, UI_TYPE::BUTTON::GOO_BTN);
	Create_UI(TEXT("Flame"), INFO(1000, 900, 133, 117), UI_TYPE::CLASS_ID::TOWER_UI, UI_TYPE::BUTTON::FLAME_BTN);
